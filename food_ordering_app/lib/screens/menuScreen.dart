  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        SizedBox(
          height: 80,
          child: Align(alignment: Alignment.centerLeft, child: _imageShape),
        ),
        SizedBox(
          height: 80,
          child: Align(
...
class CustomDiamond extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(
      size.width * 0.5140600,
      size.height * 0.9574800,
    ...
    path.quadraticBezierTo(
      size.width * 0.9500400,
      size.height * 0.5009400,
      size.width * 0.9000000,
    ...
    path.quadraticBezierTo(
      size.width * 0.5029400,
      size.height * 0.0446800,
