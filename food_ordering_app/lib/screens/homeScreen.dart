...
class RecentItemCard extends StatelessWidget {
  const RecentItemCard({Key? key, required String name, required Image image})
    : _name = name,
      _image = image,
      super(key: key);
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ClipRRect(
          borderRadius: BorderRadius.circular(10),
          child: Container(width: 80, height: 80, child: _image),
        ),
        SizedBox(width: 10),
        Expanded(
          child: Container(
...
class MostPopularCard extends StatelessWidget {
  const MostPopularCard({Key? key, required String name, required Image image})
    : _name = name,
      _image = image,
      super(key: key);
...
class RestaurantCard extends StatelessWidget {
  const RestaurantCard({Key? key, required String name, required Image image})
    : _image = image,
      _name = name,
      super(key: key);
...
class CategoryCard extends StatelessWidget {
  const CategoryCard({Key? key, required Image image, required String name})
    : _image = image,
      _name = name,
      super(key: key);
