...
class QLNhaHangPage extends StatefulWidget {
  static const routeName = "/QLNhaHangPage";
  const QLNhaHangPage({super.key});

  @override
  State<QLNhaHangPage> createState() => _QLNhaHangPageState();
}

class _QLNhaHangPageState extends State<QLNhaHangPage> {
